...
$url = "http://${IP_Power_username}:${IP_Power_password}@$IP_Power_IP/Set.cmd?CMD=SetPower+$Power_Option_4=$Power_off"
cmd /c "curl $url"
...
$url = "http://${IP_Power_username}:${IP_Power_password}@$IP_Power_IP/Set.cmd?CMD=SetPower+$Power_Option_4=$Power_On"
cmd /c "curl $url"
